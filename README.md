...
My current TwinBasic/RC6 PSD program being worked upon now, in progress, you can download it but do expect some functionality to be incomplete and unpolished, especially as it is using a Beta-grade Compiler (TwinBasic). Estimated at 99% graphically complete but only 77% code-complete. I am always adding in new functionality as this is an educational project for me. 
